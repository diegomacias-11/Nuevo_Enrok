(function () {
  const raw = document.getElementById("dispersiones-dashboard-data");
  ...
  renderDoughnut("dispersionesPorServicio", data.servicio, "servicio");
  renderBar("dispersionesPorCliente", data.cliente, "cliente", false);
  renderBar("dispersionesPorPago", data.estatus_pago, "estatus_pago", false);
})();
